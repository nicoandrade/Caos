...
( function( $ ) {
    ...
    */
    	...
    	------------------------------ */
    	//Welcome Message
		wp.customize( 'caos_welcome_title', function( value ) {
			value.bind( function( to ) {
				$( '.welcome-intro .intro-line' ).text( to );
			} );
		} );
		//Link Title
		wp.customize( 'caos_welcome_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.welcome-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'caos_welcome_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.welcome-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Background Image
		wp.customize( 'caos_welcome_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
		...
		wp.customize( 'caos_welcome_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Enable/Disable Section
		wp.customize( 'caos_services_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Quote
		wp.customize( 'caos_quote', function( value ) {
			value.bind( function( to ) {
				$( '.quote-section .quote-wrap blockquote' ).text( to );
			} );
		} );
		//Quote Author
		wp.customize( 'caos_quote_cite', function( value ) {
			value.bind( function( to ) {
				$( '.quote-section .quote-cite' ).html( to );
			} );
		} );
		//Quote Image
		wp.customize( 'caos_quote_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "") {
					$.ajax({
		...
		//Background Color
		wp.customize( 'caos_quote_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.quote-background' ).css( 'background-color', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_quote_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.quote-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'caos_video_title', function( value ) {
			value.bind( function( to ) {
				$( '.video-section .video-text-wrap .video-text-title' ).text( to );
			} );
		} );
		//Text
		wp.customize( 'caos_video_text', function( value ) {
			value.bind( function( to ) {
				$( '.video-section .video-text-wrap p' ).html( to );
			} );
		} );
		//Link Title
		wp.customize( 'caos_video_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.video-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'caos_video_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.video-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_video_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.video-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Background Image
		wp.customize( 'caos_testimonial_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
		...
		//Enable/Disable Section
		wp.customize( 'caos_testimonial_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Featured Image
		wp.customize( 'caos_image_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
    	...
    	//Title
		wp.customize( 'caos_image_title', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .image-text .image-text-title' ).text( to );
			} );
		} );
		//Text
		wp.customize( 'caos_image_text', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .image-text p' ).html( to.replace(/\n\r?/g, '<br />') );
			} );
		} );
		//Link Title
		wp.customize( 'caos_image_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'caos_image_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_image_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.image-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'caos_team_title', function( value ) {
			value.bind( function( to ) {
				$( '.team-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_team_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.team-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Phone Image
		wp.customize( 'caos_phone_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
					$.ajax({
						url: wp_customizer.ajax_url,
		...
		//Link Title
		wp.customize( 'caos_phone_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'caos_phone_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Background Color
		wp.customize( 'caos_phone_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section' ).css( 'background-color', to );
			} );
		} );
		//Phone Color
		wp.customize( 'caos_phone_color', function( value ) {
			value.bind( function( to ) {
				if ( to == "gray" ) {
		...
		//Enable/Disable Section
		wp.customize( 'caos_phone_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.phone-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'caos_tagline_text', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section .tagline' ).text( to );
			} );
		} );
		//Sub-text
		wp.customize( 'caos_tagline_sub_text', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section span' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'caos_tagline_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section a' ).attr( 'href', to );
			} );
		} );
		//Background Color
		wp.customize( 'caos_tagline_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section' ).css( 'background-color', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_tagline_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'caos_clients_title', function( value ) {
			value.bind( function( to ) {
				$( '.clients-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_clients_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'caos_map_title', function( value ) {
			value.bind( function( to ) {
				$( '.map-section .section-title' ).text( to );
			} );
		} );
		//Text
		wp.customize( 'caos_map_text', function( value ) {
			value.bind( function( to ) {
				$( '.map-section .map-text' ).html( to.replace(/\n\r?/g, '<br />') );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_map_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.map-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'caos_pricing_title', function( value ) {
			value.bind( function( to ) {
				$( '.pricing-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_pricing_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'caos_portfolio_title', function( value ) {
			value.bind( function( to ) {
				$( '.portfolio-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_portfolio_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'caos_blog_title', function( value ) {
			value.bind( function( to ) {
				$( '.blog-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'caos_blog_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.blog-section' ).show();	
				}else{
